...
public class APIFactory	{
    ...
    public String availableCoins() {
        try {
            return Web.getURL(SHAPESHIFT_GETCOINS);
        }
        catch(Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String marketInfo() {
        try {
            return Web.getURL(SHAPESHIFT_MARKETINFO);
        }
        catch(Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String rate(String pair) {
        try {
            return Web.getURL(SHAPESHIFT_RATE + pair);
        }
        catch(Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String limit(String pair) {
        try {
            return Web.getURL(SHAPESHIFT_LIMIT + pair);
        }
        catch(Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String txStatus(String addr) {
        try {
            return Web.getURL(SHAPESHIFT_TX_STATUS + addr);
        }
        catch(Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String normalTx(String pair, String withdrawalAddress, String returnAddress) {
        ...
        try {
            ...
            return Web.postURL("application/json", SHAPESHIFT_SHIFT, jsonObject.toString());
        }
        catch(JSONException je) {
            je.printStackTrace();
            jsonObject = null;
