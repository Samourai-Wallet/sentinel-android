...
//                    }
//                    else    {
//                        addressP2PKH = privKeyReader.getKey().toAddress(SentinelState.Companion.getNetworkParam()).toString();
//                        Log.d("SweepUtil", "address derived P2PKH:" + addressP2PKH);
//                        addressP2SH_P2WPKH = new P2SH_P2WPKH(privKeyReader.getKey(), SentinelState.Companion.getNetworkParam()).getAddressAsString();
//                        Log.d("SweepUtil", "address derived P2SH_P2WPKH:" + addressP2SH_P2WPKH);
//                        addressP2WPKH = new SegwitAddress(privKeyReader.getKey(), SentinelState.Companion.getNetworkParam()).getBech32AsString();
