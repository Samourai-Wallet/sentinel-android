package com.samourai.sentinel.ui.views.swipeLayout;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     *
     * @param enabled Whether dragging from anywhere within the activity should start swipe
     *                back.
     */
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                ...
                mScrollPercent = Math.abs(
                        (float) top / (mContentView.getHeight() + mShadowTop.getIntrinsicHeight()));
            }
            mContentLeft = left;
            mContentTop = top;
            invalidate();
