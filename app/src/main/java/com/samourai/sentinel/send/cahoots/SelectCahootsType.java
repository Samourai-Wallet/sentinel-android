//package com.samourai.sentinel.send.cahoots;
//
...
//        ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(getActivity(), R.style.SamouraiAppTheme); // your app theme here
